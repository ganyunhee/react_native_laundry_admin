    ...
    return (
        <YStack backgroundColor="$blue3" flex={1} justifyContent="center" width="100%">
            ...
            <YStack alignSelf="center" marginTop="$6" space="$5" width={300} justifyContent="center">
                <SizableText size="$6" alignSelf="center">Already have an account? <SizableText theme="alt2" size="$6" fontWeight="800" onPress={() => {console.log("Login Clicked")}}>Login</SizableText></SizableText>
            </YStack>
        </YStack>
    )
}